function n = nv(material,tmp, unit)
if(nargin ==0)
    material='si';
    tmp=300;
    unit=1e-6;
...
if(strcmp(material,'si'))
    relative_mass=const.relative_hole_mass_si;
elseif(strcmp(material,'gaas'))
    relative_mass=const.relative_hole_mass_gaas;
elseif(strcmp(material,'ge'))
     relative_mass=const.relative_hole_mass_ge;
end
